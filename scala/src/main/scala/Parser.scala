...
class Parser(
  ...
  private val OPCODES: Map[(SymbolType, VarType), List[String]] = Map(
    ...
    (SymbolType.Div, VarType.VarTypeInt) ->
        List("xchg EAX, EBX", "cdq", "idiv EBX"),
    (SymbolType.Plus, VarType.VarTypeFloat) -> List("addsd XMM0, XMM1"),
    (SymbolType.Mult, VarType.VarTypeFloat) -> List("mulsd XMM0, XMM1"),
    (SymbolType.Minus, VarType.VarTypeFloat) ->
        List("subsd XMM1, XMM0", "movq XMM0, XMM1"),
    (SymbolType.Div, VarType.VarTypeFloat) ->
        List("divsd XMM1, XMM0", "movq XMM0, XMM1"),
    (SymbolType.EqEq, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setz AL"),
    (SymbolType.Neq, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setnz AL"),
    (SymbolType.Lt, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setl AL"),
    (SymbolType.Leq, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setle AL"),
    (SymbolType.Gt, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setg AL"),
    (SymbolType.Geq, VarType.VarTypeInt) -> List("cmp EBX, EAX", "setge AL"),
    (SymbolType.EqEq, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "setz AL"),
    (SymbolType.Neq, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "setnz AL"),
    (SymbolType.Lt, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "setb AL"),
    (SymbolType.Leq, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "setbe AL"),
    (SymbolType.Gt, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "seta AL"),
    (SymbolType.Geq, VarType.VarTypeFloat) -> List("comisd XMM1, XMM0", "setae AL"),
    ),
  private val CMP_SYMBOLS: List[SymbolType] = List(
    SymbolType.EqEq,
    SymbolType.Neq,
    SymbolType.Lt,
    SymbolType.Leq,
  ...
  private def statement(): Unit =
    _token.tokenType() match
      ...
      case TokenType.Variable => parseAssignment()
  ...
  private def parsePrint(): Unit =
    val isPrintln = _token.keyword() == KeywordType.Println
